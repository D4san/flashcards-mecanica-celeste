...
const initialFlashcards: Flashcard[] = [
  {
    "question": "En un problema de dos cuerpos, una energía mecánica total negativa garantiza que el sistema nunca se desbaratará. ¿Por qué esta regla de oro fracasa cuando aplicamos el mismo criterio a un sistema de N-cuerpos?",
    "answer": "Porque en un sistema de múltiples cuerpos, las interacciones y acercamientos complejos entre las partículas pueden provocar fuertes transferencias de energía. Una de las partículas puede robar suficiente energía cinética durante una aproximación para superar la velocidad de escape y salir expulsada, dejando al resto del sistema aún más ligado, todo esto manteniendo la energía total estricta e invariablemente negativa."
  },
  {
    "question": "En la convención de la mecánica celeste (el Gauge celeste), los sistemas planetarios y estelares ligados siempre tienen energías potenciales y totales negativas. Desde una perspectiva física, ¿qué representa que un sistema tenga una energía total de -28 unidades?",
    "answer": "Representa un \"déficit\". Ese valor numérico negativo es exactamente la cantidad de energía que habría que inyectarle o cederle al sistema desde el exterior (con un choque, radiación, etc.) para desbaratarlo por completo. Si se le entregan esas 28 unidades, su energía total pasaría a cero, dándole a los cuerpos apenas la energía necesaria para escapar a una distancia infinita y llegar allí al reposo."
  },
  {
    "question": "Filosóficamente, ¿qué límite nos impone el Teorema de Bruns (1887) a la hora de querer predecir el futuro exacto del universo o del sistema solar mediante ecuaciones matemáticas elementales?",
    "answer": "Nos impone una barrera de imposibilidad algebraica. Para predecir exactamente la dinámica de un sistema de N-cuerpos, necesitaríamos encontrar 6N constantes de movimiento (cuadraturas). Sin embargo, el Teorema de Bruns demostró que en la naturaleza solo existen 10 cuadraturas algebraicas fundamentales (las derivadas del centro de masa, momento lineal, momento angular y la energía). Al ser matemáticamente incompleto, el problema no tiene una solución algebraica exacta mediante funciones elementales."
  },
  {
    "question": "Dado que la conservación de la energía no basta para saber si un cúmulo de estrellas se dispersará, Lagrange propuso observar el momento de inercia (I) del sistema. ¿Cómo se interpreta conceptualmente la evolución asintótica del momento de inercia en el destino del sistema?",
    "answer": "El momento de inercia mide espacialmente qué tan esparcidas están las masas respecto al origen. Si I tiende a infinito con el tiempo, es garantía de que el sistema se está dispersando de manera irreversible (no ligado). Por el contrario, si I tiende a cero, indica que todas las partículas terminarán colisionando en el centro (colapso gravitacional)."
  },
  {
    "question": "¿Por qué el Virial Escalar (G, o la tasa de cambio instantánea del momento de inercia) resulta ser una herramienta mucho más informativa y potente para evaluar la estabilidad de un sistema que simplemente tomarle una \"foto\" a las posiciones de las estrellas?",
    "answer": "Porque el Virial Escalar acopla en un solo número tanto las posiciones como las velocidades de las partículas simultáneamente. Si tomas una foto, podrías ver un cúmulo de estrellas muy juntas y creer que es estable, pero si esas estrellas viajan a velocidades altísimas, el sistema se desbaratará rápidamente. El Virial Escalar captura ese comportamiento dinámico completo."
  },
  {
    "question": "Si observamos una galaxia que lleva miles de millones de años existiendo sin dispersarse ni colapsar, ¿qué relación fundamental y asintótica deben cumplir sus energías según el Teorema del Virial?",
    "answer": "En un sistema de N-cuerpos estable asintóticamente (virializado), el promedio temporal de su energía no es 1 a 1. Se ajusta a un balance exacto donde la magnitud de la energía potencial promedio es el doble de la energía cinética promedio (<U> = -2<K>).",
    "nanswer": "Al estar en un perfecto equilibrio dinámico sin colapsar ni dispersarse, las fuerzas se cancelan. Esto significa que la energía potencial gravitatoria (que intenta colapsar el sistema) y la energía cinética (que intenta dispersarlo) se equilibran perfectamente en una relación 1 a 1, resultando en <U> = -<K>. Esta trampa apela a la falsa intuición de que \"equilibrio\" siempre significa un balance simétrico al 50/50.",
    "isTrap": true
  },
  {
    "question": "Conceptualmente, ¿qué diferencia a un sistema \"colisional\" (como un cúmulo estelar denso) de un sistema \"no colisional\" (como el disco de una galaxia) si ambos están compuestos por miles o millones de estrellas interactuando por gravedad?",
    "answer": "La diferencia central es la relación entre la edad del sistema y su tiempo de relajación (el tiempo que tarda una partícula en acumular suficientes desviaciones gravitacionales como para \"olvidar\" su velocidad inicial). En un sistema colisional, la edad del sistema es mayor que el tiempo de relajación, por lo que las interacciones por pares moldean el cúmulo. En los no colisionales, el tiempo de relajación es muchísimo más grande que la edad de la galaxia, por lo que las estrellas no sufren el efecto de encuentros cercanos, sino que orbitan dentro de un campo gravitacional global y suavizado."
  },
  {
    "question": "Si detectamos que un cometa rasante al Sol tiene una energía mecánica total de cero (E=0), ¿qué nos dice exactamente este valor sobre el futuro geométrico y cinético de ese cometa?",
    "answer": "Un valor exacto de cero indica que la energía cinética del cometa iguala en magnitud a su energía potencial (déficit gravitacional). Físicamente, esto implica que posee apenas la velocidad de escape exacta para no volver jamás, trazando una órbita parabólica abierta y agotando todo su impulso únicamente al llegar al infinito, donde quedaría en reposo."
  },
  {
    "question": "Existe un mito según el cual si sustituimos a Júpiter por un asteroide del tamaño de un guijarro (manteniendo su vector de velocidad), la trayectoria de ese guijarro sería idéntica a la que tenía el planeta original, argumentando que la masa se \"cancela\" en caída libre. ¿Por qué este pensamiento es erróneo en el problema de N-cuerpos?",
    "answer": "El pensamiento es erróneo porque asume que el cuerpo central (el Sol) permanece estático e inamovible. Esa cancelación matemática solo funciona para \"partículas de prueba\" de masa insignificante. En la realidad de los N-cuerpos, la inmensa masa de un planeta como Júpiter mueve consigo al Sol (y al centro de masa del sistema) debido a la conservación del momentum. Si reducimos Júpiter a un guijarro, el Sol dejaría de oscilar de la misma manera, alterando el campo de fuerzas en todo el sistema solar y haciendo que la trayectoria del guijarro sea radicalmente distinta.",
    "nanswer": "De hecho, el mito no es erróneo; es físicamente correcto. Según el Principio de Equivalencia de Galileo y la Ley de Gravitación Universal de Newton (ma = GmM/r^2), la masa del objeto que orbita (m) se cancela en ambos lados de la ecuación, dejando la aceleración como a = GM/r^2. En el vacío del espacio, un guijarro y un gigante gaseoso caen y orbitan exactamente igual. Esta trampa tiene sentido porque utiliza la cancelación matemática real enseñada en física básica para justificar una premisa incompleta.",
    "isTrap": true
  }
]
